...
public class ControladorMenu {
    ...
    public void ingresarEstudiante(){
        ...
        if(instituto.getEstudianteDAO().agregarEstudiante(nombre, apellidos, nacimiento, correoIns, correoPer, celular, fijo, programa, instituto.getEstudiantes())){
    ...
    public void modificarEstudiante(){
        ...
        if (resultado != null){
            ...
            instituto.getEstudianteDAO().borrarEstudiante(correoIns, instituto.getEstudiantes());//Eliminamos el estudiante que se busca para modificarlo.
            instituto.getEstudianteDAO().agregarEstudiante(nombre, apellidos, nacimiento, correoIns, correoPer, celular, fijo, programa, instituto.getEstudiantes());
    ...
    public void borrarEstudiante(){
        ...
        if(instituto.getEstudianteDAO().borrarEstudiante(correoIns, instituto.getEstudiantes())){
    ...
    public void directorio(){
        ...
        vista.mostrarDatos(instituto.getEstudianteDAO().datosEstudiantes(instituto.getEstudiantes()));
    }
}
